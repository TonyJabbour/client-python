...
class Infrastructure:
    ...
    def create(self, **kwargs):
        ...
        x_opencti_cpe_cpe23 = kwargs.get("x_opencti_cpe_cpe23", None)
        x_opencti_cpe_product = kwargs.get("x_opencti_cpe_product", None)
        x_opencti_cpe_version = kwargs.get("x_opencti_cpe_version", None)
        x_opencti_cpe_vendor = kwargs.get("x_opencti_cpe_vendor", None)
            ...
            result = self.opencti.query(
                query,
                {
                    "input": {
                        ...
                        "x_opencti_cpe_cpe23": x_opencti_cpe_cpe23,
                        "x_opencti_cpe_product": x_opencti_cpe_product,
                        "x_opencti_cpe_version": x_opencti_cpe_version,
                        "x_opencti_cpe_vendor": x_opencti_cpe_vendor,
                        "update": update,
                    }
                },
            )
    ...
    def import_from_stix2(self, **kwargs):
        ...
        if stix_object is not None:
            return self.create(
                ...
                x_opencti_cpe_cpe23=stix_object[
                    "x_opencti_cpe_cpe23"
                ]
                if "x_opencti_cpe_cpe23" in stix_object
                else None,
                x_opencti_cpe_product=stix_object[
                    "x_opencti_cpe_product"
                ]
                if "x_opencti_cpe_product" in stix_object
                else None,
                x_opencti_cpe_version=stix_object[
                    "x_opencti_cpe_version"
                ]
                if "x_opencti_cpe_version" in stix_object
                else None,
                x_opencti_cpe_vendor=stix_object[
                    "x_opencti_cpe_vendor"
                ]
                if "x_opencti_cpe_vendor" in stix_object
                else None,
