...
class StixCyberObservable:
    def __init__(self, opencti, file):
        ...
        self.properties = """
            ...
            ... on IPv4Addr {
                value
                x_opencti_abuseipdb_confidence
                x_opencti_abuseipdb_country
                x_opencti_abuseipdb_isp
            }
            ... on IPv6Addr {
                value
            }
    ...
    def create(self, **kwargs):
        ...
        x_opencti_abuseipdb_confidence = kwargs.get("x_opencti_abuseipdb_confidence", None)
        x_opencti_abuseipdb_country = kwargs.get("x_opencti_abuseipdb_country", None)
        x_opencti_abuseipdb_isp = kwargs.get("x_opencti_abuseipdb_isp", None)
        ...
        if type is not None:
            ...
            if type == "Autonomous-System":
                ...
                input_variables["IPv4Addr"] = {
                    ...
                    "x_opencti_abuseipdb_confidence": observable_data["x_opencti_abuseipdb_confidence"]
                    if "x_opencti_abuseipdb_confidence" in observable_data
                    else None,
                    "x_opencti_abuseipdb_country": observable_data["x_opencti_abuseipdb_country"]
                    if "x_opencti_abuseipdb_country" in observable_data
                    else None,
                    "x_opencti_abuseipdb_isp": observable_data["x_opencti_abuseipdb_isp"]
                    if "x_opencti_abuseipdb_isp" in observable_data
                    else None,
                }
            elif type == "IPv6-Addr":
